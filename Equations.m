...
for i=1:Nz
    for k=1:Nr 
        ...
        E_T(i,k)= -u0*Density_fluid(i,k)*Cpf(i,k)*Az(i+1,2:end-1)*T(:,k) - u0*Density_fluid(i,k)*Cpf(i,k)*Az(i+1,1)*(u0*Density_fluid(i,k)*Cpf(i,k)*T0 + kez*Az(1,2:end-1)*T(:,k) + kez*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + kez*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Density_fluid(i,k)*Cpf(i,k) - kez*Az(1,1))) -u0*Density_fluid(i,k)*Cpf(i,k)*Az(i+1,end)*(Az(end,1:end-1)*T(2:end-1,k) - Az(end,1)*(u0*Density_fluid(i,k)*Cpf(i,k)*T0 + kez*Az(1,2:end-1)*T(:,k) + kez*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + kez*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Density_fluid(i,k)*Cpf(i,k) - kez*Az(1,1))) )/Az(end,end)...
            + kez*Bz(i+1,2:end-1)*T(:,k) + kez*Bz(i+1,1)*(u0*Density_fluid(i,k)*Cpf(i,k)*T0 + kez*Az(1,2:end-1)*T(:,k) + kez*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + kez*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Density_fluid(i,k)*Cpf(i,k) - kez*Az(1,1))) + kez*Bz(i+1,end)*(Az(end,1:end-1)*T(2:end-1,k) - Az(end,1)*(u0*Density_fluid(i,k)*Cpf(i,k)*T0 + kez*Az(1,2:end-1)*T(:,k) + kez*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + kez*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Density_fluid(i,k)*Cpf(i,k) - kez*Az(1,1))) )/Az(end,end) + ker/r_nodes(k+1)*Ar(k+1,2:end-1)*T(i,:) ...
            + ker/r_nodes(k+1)*Ar(k+1,1)*(-Ar(1,2:end-1)*T(i,:) - ker*Ar(1,end)*(Ar(end,2:end-1)*T(i,:) + hw*Tb)/(hw - ker*Ar(end,end)))/((1 + (ker*Ar(1,end)*Ar(end,1))/(hw - ker*Ar(end,end)))*Ar(1,1)) + ker/r_nodes(k+1)*Ar(k+1,end)*(ker*Ar(end,2:end-1)*T(i,:) + hw*Tb + ker*Ar(end,1)*(-Ar(1,2:end-1)*T(i,:) - ker*Ar(1,end)*(Ar(end,2:end-1)*T(i,:) + hw*Tb)/(hw - ker*Ar(end,end)))/((1 + (ker*Ar(1,end)*Ar(end,1))/(hw - ker*Ar(end,end)))*Ar(1,1)))/(hw - ker*Ar(end,end)) + ker*Br(k+1,2:end-1)*T(i,:) + ker*Br(k+1,1)*(-Ar(1,2:end-1)*T(i,:) - ker*Ar(1,end)*(Ar(end,2:end-1)*T(i,:) + hw*Tb)/(hw - ker*Ar(end,end)))/((1 + (ker*Ar(1,end)*Ar(end,1))/(hw - ker*Ar(end,end)))*Ar(1,1)) ...
            + ker*Br(k+1,end)*(ker*Ar(end,2:end-1)*T(i,:) + hw*Tb + ker*Ar(end,1)*(-Ar(1,2:end-1)*T(i,:) - ker*Ar(1,end)*(Ar(end,2:end-1)*T(i,:) + hw*Tb)/(hw - ker*Ar(end,end)))/((1 + (ker*Ar(1,end)*Ar(end,1))/(hw - ker*Ar(end,end)))*Ar(1,1)))/(hw - ker*Ar(end,end)) + (1-epsilon)*hg*as*(Ts(i,k) - T(i,k));
